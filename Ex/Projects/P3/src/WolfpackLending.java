...
public class WolfpackLending {
    ...
    public static final int SUBTRACT_MONTH_30 = 30;

    /**What to subtract from if days exceed 28*/
    public static final int SUBTRACT_MONTH_FEB = 29;
    ...
    public static double getInterestRate(int loanAmount, int creditScore, int income) {
        ...
        if (creditScore >= 720) {
            return 5.5;
        } else if (creditScore < 720 && income >= (5 * (loanAmount))) {
            return 6;
        } else if (creditScore >= 500 && income >= (3 * (loanAmount))) {
            return 6.5;
        } else if ((creditScore >= 350) && income >= (2 * (loanAmount))) {
            return 7.5;
        } else
            return -1;
    ...
    public static String getDisbursementDate(int applicationMonth, int applicationDay,
        ...
        if (dateCheck == false) {
            ...
            if (expressProcessing == true) {
                ...
                } else if (m != 2 && d > SUBTRACT_MONTH_30) {
                    m++;
                    d -= SUBTRACT_MONTH_30;
                }
    ...
    public static boolean isValidDate(int month, int day) {
        if ((month == 1) ||
            ...
            if (month > 12 || month < 1)
                ...
                return true;
        } else if ((month <= 12 && month >= 1) && (day <= SUBTRACT_MONTH_30) && (day > 0)) {
            if ((month == 2) && (day > 29))
                return false;
            return true;
        } else
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Loan Ammount (1000-10000): ");
