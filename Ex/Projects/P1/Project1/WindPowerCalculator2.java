...
public class WindPowerCalculator{
	...
	//		double e = this.min_eff; //efficiency declaration
			...
			System.out.print("     " + velocity + ": ");
				...
				for(efficiency=efficiency; efficiency<= this.max_eff; efficiency+= this.eff_inc){
					output = (efficiency*0.5*dens*area* (double)Math.pow(velocity, 3)/this.watts_p_kilowatt);
		...
		public static void main(String[] args){
			windPowerCalc wPC = new WindPowerCalculator();
			//int min = this.min_v;
			//int max = this.max_v;
