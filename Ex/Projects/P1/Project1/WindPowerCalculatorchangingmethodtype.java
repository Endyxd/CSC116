...
public class WindPowerCalculatorchangingmethodtype{
		
		public double calculateWindPower(int efficiency, int bladesDiameter, int velocity){
	//		double e = this.min_eff; //efficiency declaration
		...
		public static void main(String[] args){
			WindPowerCalculatorchangingmethodtype wPC = new WindPowerCalculatorchangingmethodtype();
			//int min = this.min_v;
			//int max = this.max_v;
