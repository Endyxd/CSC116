...
public class windPowerCalc{
		...
		public void calculateWindPower(int velocity){
			...
			double radius = ((double)this.diameter/2); //this declaration calculates the radius from the diameter as to not clutter the next variable
		...
		public static final double min_eff = 0.20; //percent
		public static final double max_eff = 0.40; //percent
		public static final double eff_inc = 0.1; //percent inc
		...
		public static void main(String[] args){
			...
			wPC.calculateWindPower(velocity);			
			}
